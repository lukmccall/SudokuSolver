...
public class CanvasTest {
    ...
    public void getInitial() {
        ...
        canvas.gameboard.modifyInitial(myInitial);
    ...
    public void clear() {
        ...
        Assert.assertArrayEquals(clearArray,canvas.gameboard.getInitial());
        ...
        canvas.gameboard.modifySolution(solution);
        canvas.clear();

        Assert.assertArrayEquals(clearArray,canvas.gameboard.getSolution());
    }
