 ...
 * If two points on Y axis have distance less or equal 10 they are treated as same point.
 * */
public class PointComparator implements Comparator<Point> {
    /**
     * @param y1 first point
     * @param y2 second point
     * @return y1 compare to y2, but if distance between this two points is less or equal 10 return 0.
     */
